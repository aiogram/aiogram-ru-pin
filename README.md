...
Эта статья призвана систематизировать знания по фреймворку и Telegram Bot API.

Если **вы новенький**, то обратитесь к разделу [FAQ-чат](#%D1%87%D0%B0%D1%82), чтобы понять как эффективно вести общение в чате.

Каждый вопрос в FAQ имеет свою ссылку. Кидайте в чат при случае.

Ошибки и предложения по тексту к [@gabbhack](http://t.me/gabbhack). Желательно кидать статьи на Telegra.ph для бесшовного чтения.
